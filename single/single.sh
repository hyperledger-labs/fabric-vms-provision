...
## client
mkdir -p ${GOPATH}/src/localhost/single/client
cp ${CURRDIR}/client/main.go  ${GOPATH}/src/localhost/single/client
cd ${GOPATH}/src/localhost/single/client
go get
go build
cp client  ${BDIR}/pkg-cli
