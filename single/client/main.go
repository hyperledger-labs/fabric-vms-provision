...
func (this *FabricSetup) Init() {
	...
	var err error
	this.sdk, err = fabsdk.New(config)
	if err != nil {
...
func (this *FabricSetup) Query(fcn string, args [][]byte) []byte {
	...
	clientChannelContext := this.sdk.ChannelContext(this.channel, fabsdk.WithUser(this.user), fabsdk.WithOrg(this.org))
...
func main() {
	...
	hfc := FabricSetup{
		user:       "User1", // this comes from crypto-config.yaml PeerOrgs:Users:Count:1 an autogenerated user by cryptogen
